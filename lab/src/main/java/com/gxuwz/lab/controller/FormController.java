...
public class FormController {
	...
	@GetMapping("/interview/{sectionId}/{planId}/{userId}/{num}")
	public String interview(@PathVariable("sectionId") Integer sectionId,@PathVariable("userId") String userId,@PathVariable("planId") Integer planId,@PathVariable("num") Integer num){

		String result = formService.interview(sectionId,planId,userId,num);
