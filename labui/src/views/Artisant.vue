...
<!--                    &lt;!&ndash; 一级菜单 &ndash;&gt;-->
<!--					 <el-submenu v-for="(item,index) in $router.options.artisanRouter" :index="index+''" >-->
<!--                   -->
        ...
        <el-container>
            ...
            <el-aside width="200px" hi>
                ...
                >
                    <!-- 一级菜单 -->
                    <el-menu-item
                            v-for="(item2, index2) in $router.options.artisanRouter[0].children"
                            :index="item2.path"
                            :key="index2"
...
<script>
    ...
    export default {
        data() {
            return {
                userid:"null",
                defaultOpeneds: [this.$router.options.artisanRouter[0].path], // 默认展开的菜单路径数组
        ...
        mounted() {
            ...
            this.defaultActive = this.$router.options.artisanRouter[0].children[0].path;
        ...
        methods: {
            ...
            handleMenuOpen(index) {
                // 当菜单展开时，将第一个菜单项设为选中
                if (index === this.$router.options.artisanRouter[0].path) {
                    this.defaultActive = this.$router.options.artisanRouter[0].children[0].path;
                }
            },
